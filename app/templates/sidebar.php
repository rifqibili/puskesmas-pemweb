    ...
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
      ...
      <li class="nav-item"><a href="javascript:;"><i class="feather icon-database"></i><span class="menu-title" data-i18n="Laporan">Setup Data Master</span></a>
        <ul class="menu-content">
                ...
                <a href="?page=dokter">
                  <i class="feather icon-user"></i><span class="menu-title" data-i18n="Dokter">Master Dokter</span>
                </a>
              </li>
        </ul>
        <ul class="menu-content">
                <li class="<?php echo is_active('obat'); ?> nav-item"><a href="?page=obat"><i class="feather icon-calendar"></i><span class="menu-title" data-i18n="Obat">Master Obat</span></a>
              </li>
        </ul>
        <ul class="menu-content">
              <li class="<?php echo is_active('ruang'); ?> nav-item"><a href="?page=ruang"><i class="feather icon-check-square"></i><span class="menu-title" data-i18n="Ruang">Master Ruang</span></a>
            </li>
        </ul>
      </li>
      ...
      <li class="<?php echo is_active('user'); ?> nav-item"><a href="?page=user"><i class="feather icon-monitor"></i><span class="menu-title" data-i18n="Rekam Medis">User</span></a>
